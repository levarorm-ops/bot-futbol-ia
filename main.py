...
# Configuración de credenciales desde Secrets de Streamlit o variables de entorno
TELEGRAM_TOKEN = st.secrets.get("TELEGRAM_TOKEN") or os.getenv("TELEGRAM_BOT_TOKEN")
GEMINI_API_KEY = st.secrets.get("GEMINI_API_KEY") or os.getenv("GEMINI_API_KEY")

# Inicialización del cliente oficial de Google Gemini (Gratuito)
