...
DB_PERFILES_TACTICOS = {
    ...
    "default": {
        ...
        "p_perd": 1.30, "p_gan": 0.80, "descanso": "72-96 horas", "fatiga": "Estándar",
...
def buscar_partido_real_en_web(texto_ingresado):
    """
    Busca de forma inteligente el emparejamiento real basado en el equipo ingresado,
    garantizando que el nombre del partido corresponda a la realidad actual.
    """
    texto_limpio = texto_ingresado.lower().strip()
    ...
    # Fallback inteligente si no hay conexión temporal a la API externa
...
if bot:
    ...
    def cmd_start(message):
        enviar_telegram_seguro(
            message.chat.id,
            "👋 **¡Bot Inteligente Multiliga Activo!**\n\nEscribe el nombre o parte del equipo que deseas consultar (ej. *Galata*, *Flamengo*, *Real*) y el sistema buscará el encuentro real de forma automática."
        )
...
@app.route('/')
def home():
    return "Bot en Tiempo Real Operativo."
